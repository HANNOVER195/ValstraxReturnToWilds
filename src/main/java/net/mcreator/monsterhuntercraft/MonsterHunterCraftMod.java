package net.mcreator.monsterhuntercraft;
...
@Mod("monster_hunter_craft")
public class MonsterHunterCraftMod {
	public static final Logger LOGGER = LogManager.getLogger(MonsterHunterCraftMod.class);
	public static final String MODID = "monster_hunter_craft";

	public MonsterHunterCraftMod() {
